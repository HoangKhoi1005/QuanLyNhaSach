...
public class PanelLoading extends javax.swing.JLayeredPane {
    ...
    public void doneLogin(TaiKhoanDTO data) {
        isMessage = false;
        this.data = data;
        pic.setIcon(ResizeImage(String.valueOf(data.getAnhNV())));
        cmdContinue.setText("Continue with " + data.getTenDN());
        animator.start();
    }
    ...
    private void cmdEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdEditActionPerformed
        ...
        if(duongDanAnh != null)
        {
            pic.setIcon(ResizeImage(String.valueOf(duongDanAnh)));
            repaint();
        }
        NhanVienDTO nv = new NhanVienDTO();
        nv.setAnhNV(duongDanAnh);
        nv.setMaNV(data.getMaNV());
        boolean kq = NhanVienDAO.capNhatAnhNhanVien(nv);
        if(kq)
        {
            JOptionPane.showMessageDialog(this, "Ảnh đã được cập nhật thành công.", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
        }
        else
        JOptionPane.showMessageDialog(this, "Cập nhật ảnh thất bại.", "Thông báo", JOptionPane.WARNING_MESSAGE);
