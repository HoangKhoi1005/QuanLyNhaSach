...
public class TextField extends JTextField {
    ...
    private final Color disabledColor = Color.BLACK;
    public TextField() {
        setUI(new TextUI());
        setOpaque(false);
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        if (isEnabled()) {
            ...
            g2.setColor(disabledColor); // Sử dụng màu xám khi disabled
        }
        g2.setColor(getBackground());
    ...
    public void setEnabled(boolean enabled) {
        ...
        repaint(); // Cập nhật lại giao diện khi trạng thái enabled thay đổi
    }
